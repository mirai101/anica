#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To anica
...
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               Meow - Meow                 |
\033[1;96m|This Tool i Only for Philippines FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|
\033[1;91m      [⚡\033[1;97mAuthor Name: anica     ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Philippines      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91manica\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
CorrectUsername = "anica"
CorrectPassword = "anica"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:anica
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe PaoLul " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91manica\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
